...
describe('WETH', function () {
    ...
    //         const balance_before_deposit = await ethers.provider.getBalance(token.address);
    //         const total_supply_before_deposit = await token.totalSupply();
    //         expect(
    //             formatEther(balance_before_deposit)
    ...
    //         const balance_after_deposit = await ethers.provider.getBalance(token.address);
    //         const total_supply_after_deposit = await token.totalSupply();
    //         expect(
    //             formatEther(balance_after_deposit)
    //         ).to.equal(formatEther("10"));

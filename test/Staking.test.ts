...
describe("Staking", function () {
    ...
    beforeEach(async function () {
        ...
        erc20_token = await ERC20.deploy('StakingToken', 'ERC20'); //ERC20 contract used for staking
        lp_token = await ERC20.deploy('RewardsToken', 'RT'); //Liquidity Pool contract used for deployment rewards

        Staking = await ethers.getContractFactory("Staking");
        staking_rewards_token = await Staking.deploy(lp_token.address, erc20_token.address);
